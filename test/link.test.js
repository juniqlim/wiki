...
const ctx = { base: '', urlOf: (p) => (p === 'programming/here.md' ? 'notes/programming/here.html' : null), wikiUrlOf: () => null };
...
test('여기 있는 노트면 내부 링크가 된다', () => {
  ...
  assert.match(html, /<a class="wiki" href="notes\/programming\/here.html">글<\/a>/);
});
